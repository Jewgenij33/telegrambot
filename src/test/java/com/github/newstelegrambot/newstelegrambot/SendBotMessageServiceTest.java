...
public class SendBotMessageServiceTest {
    ...
    private NewTelegramBot newsbot;

    @BeforeEach
    public void init() {
        newsbot = Mockito.mock(NewTelegramBot.class);
        sendBotMessageService = new SendBotMessageServiceImpl(newsbot);
    }
    ...
    public void shouldProperlySendMessage() throws TelegramApiException {
        ...
        Mockito.verify(newsbot).execute(sendMessage);
    }
}
